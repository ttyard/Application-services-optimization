...
external_url 'http://gitlab.wanglijie.cn'
...
# gitlab_rails['gitlab_ssh_host'] = 'ssh.host_example.com'
 ...
 gitlab_rails['gitlab_email_from'] = 'gitlab@163.com'
 gitlab_rails['gitlab_email_display_name'] = 'Gitlab'
 gitlab_rails['gitlab_email_reply_to'] = 'gitlab@163.com'
...
# # With self-hosted email servers, this is usually the user part of the email address.
 gitlab_rails['incoming_email_email'] = "gitlab@163.com"
# # Email account password
 gitlab_rails['incoming_email_password'] = "email-password"
#
# # IMAP server host
...
# gitlab_rails['artifacts_path'] = "/data/gitlab/gitlab-rails/shared/artifacts"
...
# gitlab_rails['pages_path'] = "/data/gitlab/gitlab-rails/shared/pages"
...
## yaml format and the spaces must be retained. Using tabs will not work.
 ...
 gitlab_rails['ldap_servers'] = YAML.load <<-'EOS' # remember to close this block with 'EOS' below
   main: # 'main' is the GitLab 'provider ID' of this LDAP server
     ...
     bind_dn: 'cn=admin,dc=pactera,dc=com'
     password: 'EDS@P18!QAZxsw2'
     active_directory: false
     allow_username_or_email_login: true
     block_auto_created_users: false
     base: 'ou=People,dc=pactera,dc=com'
     user_filter: ''
     attributes:
...
#
   secondary: # 'secondary' is the GitLab 'provider ID' of second LDAP server
     ...
     uid: 'uid'
     method: 'plain' # "tls" or "ssl" or "plain"
     bind_dn: 'cn=Manager,dc=pactera,dc=com'
     password: 'EDS@P18!QAZxsw2'
     active_directory: false
     allow_username_or_email_login: true
     block_auto_created_users: false
...
# Use smtp instead of sendmail/postfix.
 ...
 gitlab_rails['smtp_user_name'] = "gitlab@163.com"
 gitlab_rails['smtp_password'] = "v2Q31jkOZUCEuSu7"
...
#
 ...
 registry_external_url 'https://registry.gitlab.wanglijie.cn'

# Settings used by GitLab application
 gitlab_rails['registry_enabled'] = true
 gitlab_rails['registry_host'] = "registry.gitlab.wanglijie.cn"
 gitlab_rails['registry_port'] = "5005"
 gitlab_rails['registry_api_url'] = "http://localhost:5000"
# gitlab_rails['registry_key_path'] = "/var/opt/gitlab/gitlab-rails/certificate.key"
 gitlab_rails['registry_path'] = "/data/gitlab/shared/docker-registry"
